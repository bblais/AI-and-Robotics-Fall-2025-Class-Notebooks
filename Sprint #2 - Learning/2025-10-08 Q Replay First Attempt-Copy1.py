...
ϵ=0.3  # random games sometimes for exploration
board_size=4
...
agent1.replay=replay
agent1.replay_buffer = deque(maxlen=10000)
agent1.step_count=0

agent1.α=α  # learning rate
agent1.γ=γ  # discount factor
agent1.ϵ=ϵ  # random games sometimes for exploration

agent2=Agent(Q_move_with_replay)
agent2.post=Q_after
agent2.Q=Table()
agent2.learning=True
agent2.replay=replay
agent2.replay_buffer = deque(maxlen=10000)
agent2.step_count=0

agent2.α=α  # learning rate
agent2.γ=γ  # discount factor
agent2.ϵ=ϵ  # random games sometimes for exploration
...
rules="chess" if chess_rules else "official"
with_replay="with replay" if replay else "without replay"
fname=f"breakthrough {rules} {board_size}x{board_size} {with_replay}"
